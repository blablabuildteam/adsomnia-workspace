    ...
    <div className="space-y-4">
      <div className="flex flex-wrap items-center gap-3">
        ...
        <a
          ...
          className="inline-flex items-center gap-1.5 border border-border bg-fill-subtle px-3 py-2 text-xs text-muted transition-colors hover:border-foreground/30 hover:text-foreground"
        >

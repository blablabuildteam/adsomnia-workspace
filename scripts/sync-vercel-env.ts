...
const SYNC_KEYS = [
  ...
  "JIRA_ADSOMNIA_API_TOKEN_EXPIRES_AT",
  "JIRA_BTR_HOST",
  "JIRA_BTR_EMAIL",
  "JIRA_BTR_API_TOKEN",
  "JIRA_BTR_API_TOKEN_EXPIRES_AT",
  "JIRA_HN_HOST",
  "JIRA_HN_EMAIL",
  "JIRA_HN_API_TOKEN",
  "JIRA_HN_API_TOKEN_EXPIRES_AT",
  "JIRA_BBB_HOST",
  "JIRA_BBB_EMAIL",
  "JIRA_BBB_API_TOKEN",
  "JIRA_BBB_API_TOKEN_EXPIRES_AT",
  "JIRA_BBB_WORKFLOW_SCHEME",
  "JIRA_BBB_TEMPLATE_PROJECT_KEY",
